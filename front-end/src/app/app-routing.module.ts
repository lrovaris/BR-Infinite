...
const routes: Routes = [
  ...
  { path: 'corretora/visualizacao', component: CorretoraViewComponent },
  ...
  { path: 'pipeline/cadastro', component: PipelinePageComponent },
  { path: 'pipeline/visualizacao', component: PipelineViewComponent },
