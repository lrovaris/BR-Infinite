...
@Component({
  ...
  templateUrl: './producao-corretora-mensal.component.html',
  styleUrls: ['./producao-corretora-mensal.component.scss']
})
export class ProducaoCorretoraMensalComponent implements OnInit {
  ...
  gerarRelatorio() {
    this.producaoService.postRelatorioCorretoraMensal(this.selectedYearStart, this.selectedMonthStart, this.selectedYearEnd, this.selectedMonthEnd, this.activeCorretora).subscribe((data: any) => {
      console.log(data);
  ...
  gerarRelatorioComparativo() {
    this.producaoService.postComparacaoCorretoraMensal(this.selectedYearStart, this.selectedMonthStart, this.selectedYearEnd, this.selectedMonthEnd, this.activeCorretora).subscribe((data: any) => {
      console.log(data);
      this.reportsArray = data.report.report;
